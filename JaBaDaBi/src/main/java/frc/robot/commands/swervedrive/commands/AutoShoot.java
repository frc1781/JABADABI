...
public class AutoShoot extends SequentialCommandGroup {
    ...
    public AutoShoot(Loader loader, Conveyor conveyor, Shooter shooter, Deploy deploy, Intake intake) {
    ...
    public AutoShoot(Loader loader, Conveyor conveyor, Shooter shooter, Deploy deploy, Intake intake, DoubleSupplier speed) {
        addRequirements(deploy, intake, loader, conveyor, shooter);
        addCommands(
            new ParallelCommandGroup(
                shooter.shoot(speed),
