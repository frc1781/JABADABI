...
public class Collector extends SubsystemBase {
    ...
    public void periodic()
  {
    ...
    Logger.recordOutput("Intake/voltage", dCollectorMotor.getBusVoltage());
    Logger.recordOutput("Intake/dutycycle", dCollectorMotor.getAppliedOutput());
    Logger.recordOutput("Deploy/position", iCollectorMotor.getEncoder().getPosition());
    Logger.recordOutput("Deploy/voltage", iCollectorMotor.getBusVoltage());
    Logger.recordOutput("Deploy/dutycycle", iCollectorMotor.getAppliedOutput());
